            ...
            <div className="heroprjcttxt">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] font-subtitle text-gunmetal dark:text-white md:text-xl">
                  ...
                  Aliquid, illum enim cum expedita sed, nobis cupiditate totam
                  dolor ex incidunt corporis, iusto nihil veritatis iure ipsa
                  porro minima ullam asperiores.{" "}
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Button className="bg-[#21ebd6] text-[#142532] hover:bg-[#237379]">
                  <Eye /> View Live Site
                </Button>
              </div>
            </div>
